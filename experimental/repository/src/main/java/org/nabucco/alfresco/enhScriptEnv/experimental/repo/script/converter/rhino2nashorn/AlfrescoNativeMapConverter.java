 ...
 */
public class AlfrescoNativeMapConverter implements ValueInstanceConverter, InitializingBean
{
    ...
    public int getForScriptConversionConfidence(final Class<?> valueInstanceClass, final Class<?> expectedClass)
    {
        ...
        if (NativeMap.class.isAssignableFrom(valueInstanceClass)
                && (expectedClass.isAssignableFrom(Map.class) || Map.class.isAssignableFrom(expectedClass)))
        {
    ...
    {
        final boolean canConvert = NativeMap.class.isInstance(value)
    ...
    public Object convertValueForScript(final Object value, final ValueConverter globalDelegate, final Class<?> expectedClass)
    {
        ...
        // TODO Check if really no one relies on the List-like access feature of NativeMap
        // ^^ otherwise we have to proxy ourselves using ListLikeMapAdapterInterceptor
