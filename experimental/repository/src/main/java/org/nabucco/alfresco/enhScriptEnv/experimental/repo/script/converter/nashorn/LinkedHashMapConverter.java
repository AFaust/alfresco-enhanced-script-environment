 ...
 */
public class LinkedHashMapConverter implements ValueInstanceConverter, InitializingBean
{
    ...
    public void afterPropertiesSet()
    {
        ...
        this.registry.registerValueInstanceConverter(LinkedHashMap.class, this);
    }
    ...
    public int getForScriptConversionConfidence(final Class<?> valueInstanceClass, final Class<?> expectedClass)
    {
        ...
        if (LinkedHashMap.class.isAssignableFrom(valueInstanceClass) && expectedClass.isAssignableFrom(valueInstanceClass))
        {
    ...
    {
        final boolean canConvert = LinkedHashMap.class.isInstance(value) && !AdapterObject.class.isInstance(value)
    ...
    public Object convertValueForScript(final Object value, final ValueConverter globalDelegate, final Class<?> expectedClass)
    {
        ...
        {
            throw new IllegalArgumentException("value must be a " + LinkedHashMap.class);
        }
