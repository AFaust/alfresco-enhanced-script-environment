...
public class NativeStringConverter implements ValueInstanceConverter, InitializingBean
{
    ...
    public void afterPropertiesSet()
    {
        ...
        this.registry.registerValueInstanceConverter(NativeString.class, this);
        this.registry.registerValueInstanceConverter(ConsString.class, this);
    }
    ...
    {
        // no need to convert java.lang.String
    ...
    public int getForJavaConversionConfidence(final Class<?> valueInstanceClass, final Class<?> expectedClass)
    {
        ...
        if ((NativeString.class.isAssignableFrom(valueInstanceClass) || ConsString.class.isAssignableFrom(valueInstanceClass))
    ...
    {
        final boolean canConvert = (NativeString.class.isInstance(value) || ConsString.class.isInstance(value))
                && expectedClass.isAssignableFrom(String.class);
        return canConvert;
    }
    ...
    {
        if (!(value instanceof NativeString) && !(value instanceof ConsString))
        {
            throw new IllegalArgumentException("value must be a " + NativeString.class);
        }

        final Object result = JSType.toString(value);
