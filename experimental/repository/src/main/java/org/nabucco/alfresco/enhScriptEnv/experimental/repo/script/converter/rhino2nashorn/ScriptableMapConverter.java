 ...
 */
public class ScriptableMapConverter implements ValueInstanceConverter, InitializingBean
{
    ...
    public void afterPropertiesSet()
    {
        ...
        this.registry.registerValueInstanceConverter(ScriptableMap.class, this);
    }
    ...
    public int getForScriptConversionConfidence(final Class<?> valueInstanceClass, final Class<?> expectedClass)
    {
        ...
        if (ScriptableMap.class.isAssignableFrom(valueInstanceClass) && expectedClass.isAssignableFrom(valueInstanceClass))
        {
    ...
    {
        final boolean canConvert = ScriptableMap.class.isInstance(value) && !AdapterObject.class.isInstance(value)
    ...
    {
        if (!(value instanceof ScriptableMap<?, ?>))
        {
            throw new IllegalArgumentException("value must be a " + ScriptableMap.class);
        }
