...
{
    var Java = JavaParam, java = javaParam, Packages = PackagesParam;

    /**
     * This script contains non-standard, Mozilla compatibility functionality on the standard global objects. Please note that it is
     * incomplete. Only the most often used functionality is supported.
     */
    ...
    if (this.importPackage === undefined)
    {
