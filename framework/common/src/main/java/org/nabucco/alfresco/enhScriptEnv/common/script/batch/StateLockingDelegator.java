...
public class StateLockingDelegator extends ObjectFacadingDelegator
{
    ...
    {
        super(refereneScope, delegee);
        this.ownerStateLock = null;
    }

    public StateLockingDelegator(final Scriptable referenceScope, final Scriptable delegee, final StateLockingDelegator owner)
    {
        super(referenceScope, delegee);
    ...
    {
        // since get operations need to iterate over slots, we need to read-lock to protected against concurrent modification
    ...
    {
        // since has operations need to iterate over slots, we need to read-lock to protected against concurrent modification
        this.stateLock.readLock().lock();
        try
        {
    ...
    {
        // TODO: should we inspect method to determine modification probability, e.g. read-lock on get/find/search functions?
